...
module.exports = class SightScript {
  ...
  /** @type {Map<string, Token>} */ _tokens = new Map();
  ...
  add (functionExe, name) {
    if(functionExe instanceof FunctionExe === false) throw new Error("Function exe should be type of FunctionExe");
    this._executor.state[name ? name : functionExe.funcname] = functionExe;
  }
