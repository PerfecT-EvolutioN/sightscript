            ...
            if(e.type === "arr" || e.type === "subexpression") {
                ...
                if(e.type === "variable") {
                    ...
                    if(actual_value.type === "variable") {
                        ...
                        if(typeof actual_value.actual_value === "undefined" || actual_value.actual_value === null ) {
                            expression_js_string = expression_js_string + `null` + (e.expression_token === "none" ? "" : e.expression_token);
                        } else if(!isNaN(Number(actual_value.actual_value)) || actual_value.actual_value === true || actual_value.actual_value === false) {
                            expression_js_string = expression_js_string + `${actual_value.actual_value}` + (e.expression_token === "none" ? "" : e.expression_token);
                        } else if (typeof actual_value.actual_value === "object" || typeof actual_value.actual_value === "function") {
                            expression_js_string = expression_js_string + `'OBJECT'` + (e.expression_token === "none" ? "" : e.expression_token);
                        }  else {
                            expression_js_string = expression_js_string + `'${actual_value.actual_value}'` + (e.expression_token === "none" ? "" : e.expression_token);
                        }
                    }
